...
Practicable mid-June to mid-September depending on snow. Access via Beauregard gondola (resort operating hours).
...
- Via Ferrata (Cars Région Haute-Savoie, ~503 m, lines N-ARAVISBUS)
- La Gonniere (Cars Région Haute-Savoie, ~620 m, lines N-ARAVISBUS)
- La Serraz (Cars Région Haute-Savoie, ~878 m, lines N-ARAVISBUS)
- Source: transport.data.gouv.fr — Licence Etalab 2.0 (2026-06-15)

## Season

May–November (snow-free)
